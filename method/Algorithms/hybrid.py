...
from method.pcfg import *
from method.Algorithms.sqrt_sampling import *
from method.Algorithms.parallel import parallel_workers
...
def hybrid(G: PCFG, DFS_depth=3, width=20, batch_size=100000, CPUs=1, timeout=5):
    ...
    if CPUs == 1:  # no parallelism
        ...
        yield from parallel_workers(
            CPUs, [(lp, timeout) for lp in list_programs], parallel_callback
        )
