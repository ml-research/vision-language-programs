    ...
    for model in "InternVL3-14B" "InternVL3-8B" "Qwen2.5-VL-7B-Instruct" "Kimi-VL-A3B-Instruct" 
    do
        ...
        for max_program_depth in 5
            ...
            for i in 0
                ...
                do
                    ...
                    --seed $i --variable_distribution $distribution --max_imgs $max_imgs --no_sampling
